package java1week1.day1;//Create a package by name: week1.day1

public class Chrome { //Create a class by name: Chrome (with no main method) in the above package
	
	public void getName() {//Create a method by name: getName() (i.e. public void getName())
		
	}

	public void printName() {//Create a method by name: PrintName() (i.e. public void PrintName())
		System.out.println("This is google chrome");//Print a statement inside the method --> "This is google chrome"
