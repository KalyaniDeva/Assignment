...
public class Bike {//Create another class as Bike
	
	public static void main(String[] args) {//Call the methods of Car class in BikeClass by creating object for Car class and Bike Class
		Car obj=new Car();
		obj.applyBreak();
		obj.soundHorn();
	}
